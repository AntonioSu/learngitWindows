    ...
    _im.defaultOptions = {
        ...
        faceHandler: function ($chat) {
            $chat.find("#face img").click(function () {
                ...
                suwenyuan.insertAtCursor(imgEL, doc, win);
            });
            // 表情隐藏
        ...
        chatLayoutTemplate: function (userJID, sender, receiver, product, flag) {
            ...
            return [
                ...
                '</select>',
                '<div class="bold"></div>',
                '<div class="underline">下</div>',
                '<div class="italic">斜</div>',
                '<div class="face"></div>',
                ...
                '<tr class="bottom-bar">',
                '<td><input type="text" id="to" name="to" value="hoojo" style="width: 100px; display: none;"/>',
